...
ActiveRecord::Schema.define(version: 20170527171347) do
  ...
  create_table "error_reports", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    ...
    t.index ["environment_id"], name: "index_error_reports_on_environment_id", using: :btree
  ...
  create_table "prconfigs", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string   "name",                     default: ""
    t.text     "content",    limit: 65535
    t.integer  "project_id"
    t.datetime "created_at",                            null: false
    t.datetime "updated_at",                            null: false
    t.index ["name"], name: "index_prconfigs_on_name", using: :btree
    t.index ["project_id"], name: "index_prconfigs_on_project_id", using: :btree
  end
  ...
  create_table "stage_builds", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer  "stage_id"
    t.integer  "changeset_id"
